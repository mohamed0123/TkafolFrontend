...
export class EditUsersComponent implements OnInit {
  ...
  displayedColumns: string[] = ['UPDATE', 'LST','CREATIONDATE' , 'BRANCH', 'AREA', 'GENDER', 'MANAGER', 'ROLE', 'EMAIL' , 'ADDRESS', 'PASSWORD', 'PHONE', 'USER_NAME'];
  checker;
...
this.dataArray.filterPredicate = (data: any, filterValue:string) => {
  ...
  onCreate() {
    ...
    let dialogRef =  this.dialog.open(CreateUsersComponent, dialogConfig);
