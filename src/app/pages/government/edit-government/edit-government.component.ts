import { Component, OnInit, ViewChild, SimpleChanges, Input, Inject } from '@angular/core';
import { MatPaginator, MatSort, MatTableDataSource, MatDialog, MatDialogConfig } from '@angular/material';
import { DialogService } from 'src/app/shared/dialog.service';
import { NotificationService } from 'src/app/shared/notification.service';
import { ExcelService } from 'src/app/helper/excel.service';
import { CreateGovernmentComponent } from '../create-government/create-government.component';
...
export class EditGovernmentComponent implements OnInit {
  ...
  constructor(private service: GovernmentService, @Inject(DOCUMENT) private document: Document,
...
this.dataArray.filterPredicate = (data: any, filterValue:string) => {
  ...
  exportAsXLSX(): void {
    ...
    console.log('test')
console.log(this.document.querySelectorAll('mat-header-cell').length)
    this.document.querySelectorAll('mat-header-cell').forEach(
      ele => {
